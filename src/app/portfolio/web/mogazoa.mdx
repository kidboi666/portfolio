...
<ResponsiveGrid hasCode>
  ...
  `queryClient`를 이용하여 서버에서 캐싱된 데이터를 Prefetch
</ResponsiveGrid>
---
### 2. 무한 스크롤 구현
<ResponsiveGrid hasCode>
...
<ResponsiveGrid hasCode>
  ...
  `productsService`를 통해 캐싱 전략을 정의하고 재사용 가능한 커스텀 훅을 제공
</ResponsiveGrid>
